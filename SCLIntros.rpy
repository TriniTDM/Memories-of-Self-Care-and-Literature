...
label greeting_reversalmcl:
    ...
    if shown_count == 0:
        ...
        m 6sua "But now I get to hang out with my most favorite person in the world."
        pause 2.0
        m 7ftu "So?"
        $ _history_list.pop()
        menu:
...
label greeting_chibikahi:
    ...
    if shown_count == 0:
        ...
        pause 0.5
        "Hey, [player]!"
        "Your friendly neighborhood Chibika here."
        "Just wanted to check on in with my favorite couple!"
...
label greeting_mcl_desk:
    ...
    m 2tku "I am. And said desk is {i}still{/i} here in the classroom. I don't have that much physical storage space, so it's staying in its little corner."
